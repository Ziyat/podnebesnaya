                ...
                <div class="row">
                    <div class="col-lg-12">
                      <ol class="breadcrumb">
                        ...
                        <li><a href="/<?php echo $lang; ?>/admin/gallery"><?php echo PHOTOS;?></a></li>
                        <li class="active"><?php echo PRODUCT_DELETE.' '.PHOTES; ?></li>
                      </ol>
                        <h4><?php echo PRODUCT_DELETE.' '.PHOTES.'  #'. $id ?></h4>
                        <p><?php echo PHOTO_MESSAGE_DELETE; ?></p>
                        <form method="post">
